...
namespace Common
{
    public static class Helper
    {
        ...
        {
            return SHA1_Encrypt(GetMD5(str));
        }
        ...
        /// <summary>
        /// 将Json 字符串转化为Object对象
        /// </summary>
        /// <typeparam name="T">object对象的类型</typeparam>
        ...
        public static string DoPostRequest(string url, string postStr)
        {
            string responseText = null;
            try
            {
                ...
                // Close the Stream object.
                dataStream.Close();
                request.Referer = url.Substring(0,url.LastIndexOf('/'));
                request.Headers["UserAgent"] = "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.99 Safari/537.36";
                //request.
